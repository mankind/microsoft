## thanks to
# https://docs.microsoft.com/en-gb/graph/tutorials/ruby?tutorial-step=3
# https://github.com/synth/omniauth-microsoft_graph/blob/master/lib/omniauth/strategies/microsoft_graph.rb
# 
